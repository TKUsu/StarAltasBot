...
class Web3 {
  constructor() {
    ...
    const CONNECTION_MAINNET = `https://smart-dawn-dinghy.solana-mainnet.discover.quiknode.pro/${information?.rpcKey}/`;
    const CONNECTION_GENESYSGO = "https://ssc-dao.genesysgo.net/";
    this.connection = new Connection(information?.customRpc || CONNECTION_MAINNET);
